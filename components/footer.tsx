      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/alphabets/hindi" className="text-gray-600 hover:text-purple-600">
                  Hindi
                </Link>
              </li>
              <li>
                <Link href="/alphabets/tamil" className="text-gray-600 hover:text-purple-600">
                  Tamil
                </Link>
              </li>
              <li>
                <Link href="/alphabets/bengali" className="text-gray-600 hover:text-purple-600">
                  Bengali
                </Link>
              </li>
              <li>
                <Link href="/alphabets/telugu" className="text-gray-600 hover:text-purple-600">
                  Telugu
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 pt-8">
          <p className="text-center text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} AlphaKids. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
